...
//Global Function, do you see the singleton
//The Hook the input system wants to put in Only listen for specific message
LRESULT CALLBACK Input::InputSystemMessageHandler(HWND window, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	//Always passes it down the chain, never block or interrupts 
