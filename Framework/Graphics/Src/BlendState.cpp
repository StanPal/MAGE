...
void MAGE::Graphics::BlendState::ClearState()
{
...
{
	ASSERT(mBlendState == nullptr, "[BlendState] blend state was not released");
}
...
void BlendState::Initialize(Mode mode)
{
	...
	ASSERT(SUCCEEDED(hr), "[BlendStaet] failed to create blend state.");
