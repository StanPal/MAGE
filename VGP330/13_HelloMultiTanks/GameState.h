...
private:
	...
	MAGE::Graphics::Camera mDebugCamera; 
	MAGE::Graphics::Camera mLightCamera;
	MAGE::Graphics::Camera* mActiveCamera = nullptr;

	MAGE::Math::Matrix4 mLightProjectionMatrix; 
	std::vector<MAGE::Math::Vector3> mViewFrustumVertices; 

	MAGE::Graphics::Mesh mTankMesh;
	MAGE::Graphics::MeshBuffer mTankMeshBuffer;
	...
	MAGE::Math::Vector3 mTankRotation = 0.0f;
	...
	std::vector<MAGE::Math::Vector3> mTankPositions;
	float mTankSpacing = 15.0f;
};